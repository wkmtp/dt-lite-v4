# DT-Lite V4.0 UAA-09 — Golden Assets & Golden Scenarios
...
建立 Golden Validation Framework。

Golden Assets 至少覆盖：

AHU、Electric Meter、Building、Camera、Parking Space。

覆盖：

Asset → Point → Mapping → Capability → Application → Assembly → Runtime。
