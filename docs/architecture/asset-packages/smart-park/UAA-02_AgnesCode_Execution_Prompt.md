# DT-Lite V4.0 UAA-02 — Asset, Template, CompositeAsset & Relationship
...
实现 AssetType、AssetTemplate、Asset、CompositeAssetTemplate、CompositeAsset、Property、Relationship。

CompositeAsset 必须支持 Tree + Graph。

使用 Smart Park Building/HVAC 和 Smart Factory ProductionLine/Machine Mock 验证同一 Contract。
...
[ ] Composite Tree PASS
[ ] Composite Graph PASS
[ ] Relationship integrity PASS
[ ] Building/HVAC 与 ProductionLine/Machine 使用同一 Runtime
[ ] 无行业专用 Universal Runtime
[ ] Asset Gate PASS
